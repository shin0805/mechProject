...
# STANDING_POS = np.array([[90, 80, 75, 100, 90, 100]])
...
WALKING_POS4 = np.array([[60, 80, 110, 100, 90, 140]])
WALKING_POS5 = np.array([[60, 80, 110, 100, 90, 100]])
# WALKING_POS5 = np.array([[60, 80, 90, 100, 110, 100]])
# WALKING_POS6 = np.array([[90, 80, 90, 100, 90, 100]])
