...
if __name__=="__main__":
  ...
  rate = rospy.Rate(10)
  walk_model_path=(os.environ['HOME'] + "/mechProject/models/walk/Chair_26-11-10-31_canWalk.onnx")
  stand_model_path=(os.environ['HOME'] + "/mechProject/models/stand/Stand_11-00-06-25_success.onnx")
  numRotationHis = 4
  numActionHis = 4
